...
def perform_predictions_and_plot(la, X_test, prior_structure, subset_of_weights, save=True):
    ...
    file_name = f"Rod, cubic, W={subset_of_weights.capitalize()}, H=Full, P={prior_structure}"
    plot_regression(
        X_train,
        y_train,
...
hessian_structure = "full"  # Alterar para "kron", "diag", "lowrank", ou "gp" conforme necessário
